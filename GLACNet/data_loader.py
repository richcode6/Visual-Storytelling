...
class VistDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        images = []
        imgPath = "/home/ashwinsr/resnetFeat152/" + str(story_id) + ".npz"
        ...
        return images, targets, photo_sequence, album_ids, story_id, imgFlag
...
def collate_fn(data):
    ...
    return image_stories, targets_set, lengths_set, photo_sequence_set, album_ids_set, storyID, preTrained
